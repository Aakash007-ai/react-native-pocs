  ...
  return (
    <G>
      ...
      <G x={boxPosX < 40 ? 40 : boxPosX} y={posY}>
        ...
        <Text x={tipTxtX} y={tipTxtY + 14} fontSize="12" textAnchor="start">
          {textY}
        </Text>
      </G>
    </G>
...
const LineChartWithTooltips1 = ({valueFormatter, ...props}) => {
...
LineChartWithTooltips1.propTypes = {
  valueFormatter: PropTypes.func,
};

LineChartWithTooltips1.defaultProps = {
  valueFormatter: value => String(value),
};

export default LineChartWithTooltips1;
